            ...
            <form action="{{ route('comics.update', $comic->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input required minlength="3" maxlength="255" value="{{ old('title', $comic->title) }}" name="title"
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control @error('thumb') is-invalid @enderror" required
                            value="{{ old('thumb', $comic->thumb) }}" name="thumb" type="url" placeholder="https://example.com"
                            pattern="https://.*">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input required value="{{ old('type', $comic->type) }}" name="type" type="text"
                    ...
                    <div class="col-6">
                        <label for="sale_date" class="form-label @error('sale_date') text-danger @enderror">Sale
                            date</label>
                        <input required value="{{ old('sale_date', $comic->sale_date) }}" name="sale_date" type="date"
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input required value="{{ old('writers', $comic->writers) }}" name="writers" type="text"
                    ...
                    <div class="col-6">
                        ...
                        <input required value="{{ old('artists', $comic->artists) }}" name="artists" type="text"
                ...
                <div class="row mb-3 ">
                    <div class="col-6">
                        ...
                        <input value="{{ old('series', $comic->series) }}" required name="series"
                    ...
                    <div class="col-6 ">
                        ...
                        <input name="price" value="{{ old('price', $comic->price) }}" required type="number" min="0.01"
