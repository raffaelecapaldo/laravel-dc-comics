            ...
            <form action="{{ route('comics.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input value="{{old('title')}}" required minlength="3" maxlength="255" name="title" type="text"
                    ...
                    <div class="col-6">
                        ...
                        <input value="{{old('thumb')}}" class="form-control @error('thumb') is-invalid @enderror" required name="thumb"
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input value="{{old('type')}}" required name="type" type="text"
                    ...
                    <div class="col-6">
                        <label for="sale_date" class="form-label @error('sale_date') text-danger @enderror">Sale
                            date</label>
                        <input value="{{old('sale_date')}}" required name="sale_date" type="date"
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input value="{{old('writers')}}" required name="writers" type="text"
                    ...
                    <div class="col-6">
                        ...
                        <input value="{{old('artists')}}" required name="artists" type="text"
                ...
                <div class="row mb-3 ">
                    <div class="col-6">
                        ...
                        <input value="{{old('series')}}" name="series" required name="series" type="text"
                    ...
                    <div class="col-6 ">
                        ...
                        <input value="{{old('price')}}" name="price" required type="number" min="0.01" max="90000" step="0.01"
